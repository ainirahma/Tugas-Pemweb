<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      //query SQL
      $query = "INSERT INTO mhs (npm, nama, jenis_kelamin, alamat, fakultas, jurusan) VALUES('$npm','$nama','$jenis_kelamin','$alamat','$fakultas','$jurusan')"; 
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:100px;" bgcolor=black>
              <li class="nav-item">
          ...
          <form action="form.php" method="POST">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" name="fakultas" required="required">
                ...
                <option value="FAD">Arsitektur dan Desain</option>
                <option value="FH">Hukum</option>
                <option value="FIK">Ilmu Komputer</option>
              </select>
            </div>
            <div class="form-group">
              <label>Jurusan</label>
              <textarea class="form-control" name="jurusan" required="required"></textarea>
            </div>
